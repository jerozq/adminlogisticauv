...
// ============================================================
// Calcular estado del informe automáticamente
// Retorna el estado derivado de los documentos subidos
// ============================================================

export function calcularEstadoInforme(actividad: InformeActividad, reembolsos: ReembolsoInforme[]): {
