          ...
          {showBack && (
            <button
              ...
              className={[
                ...
                'border border-white/40 dark:border-white/16',
                'shadow-[0_1px_4px_rgba(0,0,0,0.08),0_1px_0_0_rgba(255,255,255,0.80)_inset]',
                'dark:shadow-[0_1px_4px_rgba(0,0,0,0.30),0_1px_0_0_rgba(255,255,255,0.08)_inset]',
                'hover:bg-white/35 dark:hover:bg-white/14',
                'active:scale-95',
