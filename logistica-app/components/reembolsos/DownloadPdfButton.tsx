...
interface DownloadPdfButtonProps {
  costo: { id: string; monto: number; pagador: string; cotizacion_items?: { descripcion?: string | null } | null; descripcion?: string | null }
  actividad: { id: string; fecha_inicio?: string | null }
  pagadorName: string
}
